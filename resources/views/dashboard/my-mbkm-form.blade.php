                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            @foreach($mbkms as $mbkm)
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <p class="text-xs font-weight-bold mb-0">{{ auth()->user()->nim }}</p>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <p class="text-xs font-weight-bold mb-0">{{ $studi->jurusan }}</p>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <p class="text-xs font-weight-bold mb-0">{{ $studi->prodi }}</p>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                    ...
                                    <td class="align-middle text-center text-sm">
                                    <td>
                                        <a href="/dashboard/informasi-mbkm/{{ $mbkm->id }}"><span
