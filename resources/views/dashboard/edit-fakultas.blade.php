...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/dashboard/fakultas/{{ $fakultas->id }}/edit" method="post">
                    @csrf
                    <div class="row">            
                        <div class="mb-3 col-10">
                            <label for="name" class="form-label">Nama</label>
                            <input class="form-control" type="text" id="name" name="name" placeholder="Masukan Nama Fakultas" value="{{ old('name', $fakultas->name) }}" autofocus required>  
                        </div>
                        @if($fakultas->status == 'Aktif')
