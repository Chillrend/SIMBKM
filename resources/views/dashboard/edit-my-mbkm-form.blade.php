                ...
                <div class="card-body">
                    <form action="/dashboard/informasi-mbkm/{{ $mbkm->id }}/edit" method="post">
                        ...
                        <div class="row">
                                    ...
                                    @foreach($tahun_ajaran as $tahun)
                                        @if(old('tahun', $mbkm->tahun_ajaran) == $tahun->id)
                                            <option value="{{ $tahun->id }}"
                                                    selected>{{ $tahun->tahun_ajaran }}</option>
                                        @else
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('tanggal_mulai') is-invalid @enderror"
                                           id="tanggal_mulai" type="date" name="tanggal_mulai"
                                           value="{{ old('tanggal_mulai', $mbkm->tanggal_mulai) }}" required>
                                    @error('tanggal_mulai')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="tanggal_selesai" class="form-control-label">Input Tanggal
                                        Selesai</label>
                                    <input class="form-control @error('tanggal_selesai') is-invalid @enderror"
                                           id="tanggal_selesai" type="date" name="tanggal_selesai"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('tempat_program_perusahaan') is-invalid @enderror"
                                           id="tempat_program_perusahaan" type="text" name="tempat_program_perusahaan"
                                           placeholder="Tempat Program (Perusahaan)"
                                           value="{{ old('tempat_program_perusahaan', $mbkm->tempat_program_perusahaan) }}"
                                           required>
                            ...
                            <div class="col-md-6" onload="radioClicked()" onclick="radioClicked()">
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="radio" name="mobilisasi" id="customRadio1"
                                           value="1" {{ $mbkm->mobilisasi == "1" ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="mobilisasi" id="customRadio2"
                                           value="0" {{ $mbkm->mobilisasi == "0" ? 'checked' : '' }}>
                            ...
                            @if($mbkm->mobilisasi == "1")
                                <div class="col-md-6" id="lokasi">
                                    <div class="form-group">
                                        <label for="lokasi_mobilisasi" class="form-control-label">Lokasi
                                            Mobilisasi</label>
                                        <input class="form-control @error('lokasi_mobilisasi') is-invalid @enderror"
                                               id="lokasi_mobilisasi" type="text" name="lokasi_mobilisasi"
                                               placeholder="Masukan Lokasi Mobilisasi"
                                               value="{{ old('lokasi_mobilisasi', $mbkm->lokasi_mobilisasi) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('lokasi_program') is-invalid @enderror"
                                           ...
                                           value="{{ old('lokasi_program', $mbkm->lokasi_program) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="program_keberapa" class="form-control-label">Pengambilan Program
                                        Ke-Berapa</label>
                                    <select class="form-select @error('program_keberapa') is-invalid @enderror"
                                            id="program_keberapa" name="program_keberapa" required>
                                        <option value="" disabled selected>Program Ke-</option>
                                        @if(old('program_keberapa', $mbkm->program_keberapa))
                                            <option value="{{ $mbkm->program_keberapa }}"
                                                    selected>{{ $mbkm->program_keberapa }}</option>
                                        @else
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="dosen_pembimbing"
                                        class="form-select @error('dosen_pembimbing') is-invalid @enderror"
                                ...
                                <div id="reset">
                                    <span id="reset-btn"
                                          class="badge badge-pill badge-md bg-gradient-warning">Reset</span>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="pembimbing_industri"
                                        class="form-select @error('pembimbing_industri') is-invalid @enderror"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="informasi_tambahan" class="form-control-label">Informasi
                                        Tambahan</label>
                                    <input class="form-control @error('informasi_tambahan') is-invalid @enderror"
                                           id="informasi_tambahan" type="text" name="informasi_tambahan"
                                           placeholder="Masukan posisi program. ex: Frontend, HR, QC "
                                           value="{{ old('informasi_tambahan', $mbkm->informasi_tambahan) }}">
                        ...
                        <button type="submit" class="btn btn-primary ms-md-auto me-3 d-flex">Update Formulir Mbkm
                        </button>
                    </form>
                </div>
            </div>
