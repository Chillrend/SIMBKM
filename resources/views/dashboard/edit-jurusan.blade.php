                ...
                <form action="/dashboard/jurusan/{{ $jurusan->id }}/edit" method="post">
                    ...
                    <div class="row">            
                        <div class="mb-3 col-10">
                            ...
                            <input class="form-control" type="text" id="name" name="name" placeholder="Masukan Nama Jurusan" value="{{ old('name', $jurusan->name) }}" autofocus required>  
                        </div>
                        <div class="col-10 mb-3">
                            ...
                            <select class="form-select" name="fakultas_id">
                                ...
                                @foreach($fakultas as $data)
                                    @if(old('fakultas_id', $jurusan->fakultas_id) == $data->id)
