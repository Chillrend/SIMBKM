        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row" id="field-matakuliah">
                    ...
                    <div class="row mt-2">
                        <label for="logcomment" class="form-control-label">Comment</label>
                        {{-- <p>{!! $logcomment[0]->body !!}</p> --}}
                        <h5>{!! $logcomment[0]->body !!}</h5>
                        {{-- <textarea class="m-2" id="comment" name="logcomment" value={!! $logcomment[0]->body !!} ></textarea> --}}
                    </div>
                </div>
