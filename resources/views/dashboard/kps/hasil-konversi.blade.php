        ...
        <div class="card mb-4">
            <div class="card-header">
              <div class="ms-md-auto d-flex">
                <h4>Data yang sudah dikonversi</h4>
                        ...
                        @foreach($konversis as $konversi)
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">
                                    ...
                                    <a href="/konversi/kps/hasil-konversi/{{ $konversi->kurikulum }}" ><span class="badge badge-primary"></span><i class="fa fa-regular fa-eye" style="color: #3eeefe;"></i></a>
                                </td>
                        @endforeach        
                      </tbody>
                    </table>
