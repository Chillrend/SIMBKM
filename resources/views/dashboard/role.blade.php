        ...
        <div class="card mb-4">
            <div class="card-header">
              <div class="ms-md-auto d-flex">
                <h4>Data Role</h4>
                <a href="/dashboard/role/create" class="btn btn-primary d-flex ms-md-auto ms-3">Buat Role</a>
            </div>
            </div>
                          ...
                          <tr>
                            ...
                            <td class="align-middle text-center text-sm">
                              @if($role->status == 'Aktif')
                                <span class="badge badge-sm bg-gradient-success">{{ $role->status }}</span>
                              @else
                                <span class="badge badge-sm bg-gradient-danger">{{ $role->status }}</span>
                              @endif    
                            </td>
                            <td class="align-middle text-center text-sm">
                              <td>
                                <a href="/dashboard/role/{{ $role->id }}" ><span class="badge badge-primary"></span><i class="fa fa-regular fa-pen" style="color: #fecb3e;"></i></a>
