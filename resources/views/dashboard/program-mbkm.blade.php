            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="align-middle text-center text-sm">
                  ...
                  <form action="/dashboard/program-mbkm/{{ $program->id }}" method="post" class="d-inline">
                    @csrf
                    @method('DELETE')
                    <button class="border-0 bg-transparent" onclick="return confirm('Apakah kamu yakin ingin menghapus program ini?')">
