                    ...
                    <table class="table align-items-center mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center text-sm">
                                <p class="text-xs font-weight-bold mb-0">{{ $data->listFakultas->name }}</p>
                            </td>
                            <td class="align-middle text-center text-sm">
                            ...
                            <td class="align-middle text-center text-sm">
                              <td>
                                <a href="/dashboard/jurusan/{{ $data->id }}" ><span class="badge badge-primary"></span><i class="fa fa-regular fa-pen" style="color: #fecb3e;"></i></a>
                                <form action="/dashboard/jurusan/{{ $data->id }}/delete" method="post" class="d-inline">
                                  @csrf
